        ...
        protected override void OnPopulateMesh(VertexHelper vh)
        {
            ...
            for (var i = 0; i < count; ++i)
            {
                ...
                if (textureSheetAnimation.enabled)
                {
                    ...
                    else if (textureSheetAnimation.frameOverTime.constant > 0) frameProgress = textureSheetAnimation.frameOverTime.constant - particle.remainingLifetime / particle.startLifetime;
#else
