...
public class CustomFortuneWheelManager : Singleton<CustomFortuneWheelManager>
{
	...
	public CustomFortuneWheelSector[] Sectors;		// All sectors objects
	...
	{
		// TODO award coins
		Debug.Log("TODO awards coins " + awardCoins);
	...
	public void RewardPowerup (int powerupId)
	{
		// TODO award powerup
		Debug.Log("TODO awards powerup " + powerupId);
		Analytics.CustomEvent("FortuneWheelAward", new Dictionary<string, object>
		{
			{ "powerup", powerupId },
			{ "coins", null }
