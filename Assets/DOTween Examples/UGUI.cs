...
public class UGUI : MonoBehaviour
{
    ...
    private void Start()
    {
        ...
        dotweenLogo.transform.DOPunchScale(new Vector3(1.05f, 1.05f, 1.05f), 1f, 1, 0.1f).SetAutoKill(false).Pause();
        ...
        relativeText.DOText(" - This text will be added to the existing one", 2).SetRelative().SetEase(Ease.Linear)
